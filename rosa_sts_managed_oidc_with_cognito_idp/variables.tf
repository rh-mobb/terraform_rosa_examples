...
variable "private_cluster" {
  type        = bool
  description = "Do you want this cluster to be private? Either true or false"
}
...
variable "rosa_admin_email" {
  description = "Your email address for the login details"
  type        = string
}

variable "rosa_password" {
  description = "The password you want your AWS Cognito user to have for the rosa-admin user"
  type        = string
  sensitive   = true
}
